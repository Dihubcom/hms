    ...
    render(){
        ...
        return(
            ...
            <Container className="Container">
                ...
                <Button color="primary"><a  onClick={this.toggle} >New Provisional Diagnosis</a></Button>
                <Modal size="lg" isOpen={this.state.modal} toggle={this.toggle} >
                    <ModalHeader toggle={this.toggle}>New ProvisionalDiagnosis</ModalHeader>
                    <ModalBody>
                        <FormGroup row>
                            <Col md={1}>
                                <Label>1.
                    ...
                    <ModalFooter>
                        <Button color="primary" onClick={this.submit.bind(this)}>Add</Button>   
...
export default NewProvisionalDiagnosis;