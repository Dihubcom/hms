                    ...
                    <CardBody>
                        <form>
                            <div className="form-group row">
                                ...
                                <input type="date" className="form-control col-md-6" ref="date" />
                            </div>
                            <div className="form-group row">
                                <label className="control-label col-md-3">Drug</label>
                                <input type="text" className="form-control col-md-6" ref="drug" />
                            </div>
                            <div className="form-group row">
                                <label className="control-label col-md-3">Quantity</label>
                                <input type="text" className="form-control col-md-6" ref="quantity" />
                            </div>
                            <div className="form-group row">
