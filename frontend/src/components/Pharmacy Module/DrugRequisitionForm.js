...
import {CardHeader, CardBlock, CardBody, Card} from 'reactstrap';
                ...
                <div className="row">                    
                    <form className="col-md-8 ">
                        ...
                        <div className="form-group row">
                            ...
                            <input type="text" className="form-control col-md-6" onChange={e =>this.setState({requisitionNo:e.target.value})} value={this.state.requisitionNo} />
                        </div>
                        <div className="form-group row">
                            <label className="col-md-3">Drugs</label>
                            <input type="text" className="form-control col-md-6" onChange={e =>this.setState({drugs:e.target.value})} value={this.state.drugs} />
                        </div>
                        <div className="form-group row">
                        ...
                        <div className="form-group row">
                            ...
                            <input type="text" className="form-control col-md-6" onChange={e =>this.setState({requestSendTo:e.target.value})} value={this.state.requestSendTo} />
                        </div>
                        <div className="form-group row">
                    ...
                    <div className="col-md-4">
                        <button className="btn btn-default btn-secondary">Send Request</button>  
                    </div>
                </div>
                </CardBody>
                </Card>
